...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/26 18:41:58 by adstuder          #+#    #+#             */
/*   Updated: 2019/03/11 19:48:07 by adstuder         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		printf_x0(int *tab, int ct)
{
	...
	if (tab[9] == 0 && tab[7] == 1 && tab[10] == 0)
		return (cntc('0'));
	if (tab[7] == 0 && tab[9] == 0 && tab[10] == 1)
		return (0);
	tab[9] >= tab[7] ? tab[7] = 0 : 0;
	tab[7] > tab[9] ? tab[7] = tab[7] - tab[9] : 0;
	if (tab[4] == 1 && (tab[10] == 0 || tab[9] > 0) && tab[9] <= 0)
	{
		ct = ct + cntc('0');
		tab[0] = -1;
		tab[9] > 0 ? tab[9]-- : tab[7]--;
...
int		sub_x(int *tab, int count, char *res, int i)
{
